      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="col-span-1 sm:col-span-2 lg:col-span-1">
            <img src={whiteLogo} alt="Finder" className="w-36 h-auto mb-4" />
            <p className="text-gray-400 mb-6">
              Premium ecommerce experience for the modern shopper. Quality products, exceptional service.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/products?filter=new" className="text-gray-400 hover:text-white transition-colors">New Arrivals</Link></li>
              <li><Link to="/products?filter=sale" className="text-gray-400 hover:text-white transition-colors">Sales</Link></li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm">
              &copy; 2026 Finder. All rights reserved.
            </p>
